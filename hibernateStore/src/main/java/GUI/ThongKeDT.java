            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(99, 99, 99)
                            .addComponent(lb_total, javax.swing.GroupLayout.PREFERRED_SIZE, 742, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
/*    public ArrayList<bill> search(String billID, String customerID, String date)
    ...
    private void btn_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_searchActionPerformed
        ...
        Date date1 = jDateChooseFrom.getDate(); 
        Date date2 = jDateChooseTo.getDate();
        filters.add( RowFilter.dateFilter(ComparisonType.AFTER, date1) );
        filters.add( RowFilter.dateFilter(ComparisonType.BEFORE, date2) );
        DefaultTableModel model = (DefaultTableModel) tbl_revenue.getModel();
        TableRowSorter<DefaultTableModel> tr = new TableRowSorter<>(model);
        tbl_revenue.setRowSorter(tr);
        RowFilter<Object, Object> rf = RowFilter.andFilter(filters);
        tr.setRowFilter(rf);
        int total = 0;
        for(int i = 0; i < tbl_revenue.getRowCount(); i++){
        int Price = (int) tbl_revenue.getValueAt(i, 4);
        total = Price+total;
        }
